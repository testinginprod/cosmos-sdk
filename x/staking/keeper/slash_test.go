...
func TestSlashAtNegativeHeight(t *testing.T) {
	...
	validator, found := getValByConsAddr(t, app.StakingKeeper, ctx, consAddr)
	require.True(t, found)
...
func TestSlashWithUnbondingDelegation(t *testing.T) {
	...
	validator, _ = getValByConsAddr(t, app.StakingKeeper, ctx, consAddr)
...
func TestSlashBoth(t *testing.T) {
	...
	// slash validator
	ctx = ctx.WithBlockHeight(12)
	validator, found := getValByConsAddr(t, app.StakingKeeper, ctx, sdk.GetConsAddress(PKs[0]))
	require.True(t, found)
...
func getValByConsAddr(t *testing.T, k keeper.Keeper, ctx sdk.Context, cons sdk.ConsAddress) (types.Validator, bool) {
	addr, err := k.Validators.Indexes.ConsAddress.First(ctx, cons)
	if err != nil {
